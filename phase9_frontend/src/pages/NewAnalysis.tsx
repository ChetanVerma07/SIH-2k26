  ...
  return (
    <div className="space-y-6">
      ...
      <Card title="D. Design Parameters">
        ...
        <fieldset disabled={draft.designMode === 'AUTO_OPTIMIZE'} className="grid md:grid-cols-3 gap-4 disabled:opacity-60">
          <Field label="Length (m)" htmlFor="length">
            <TextInput id="length" type="number" value={draft.design.length} onChange={(e) => setDraft((d) => ({ ...d, design: { ...d.design, length: Number(e.target.value) } }))} />
          </Field>
          <Field label="Width (m)" htmlFor="width">
            <TextInput id="width" type="number" value={draft.design.width} onChange={(e) => setDraft((d) => ({ ...d, design: { ...d.design, width: Number(e.target.value) } }))} />
          </Field>
          <Field label="Height (m)" htmlFor="height">
            <TextInput id="height" type="number" value={draft.design.height} onChange={(e) => setDraft((d) => ({ ...d, design: { ...d.design, height: Number(e.target.value) } }))} />
          </Field>
          <Field label="Wall Thickness (m)" htmlFor="wall-thick">
            <TextInput id="wall-thick" type="number" step="0.01" value={draft.design.wallThickness} onChange={(e) => setDraft((d) => ({ ...d, design: { ...d.design, wallThickness: Number(e.target.value) } }))} />
          </Field>
          <Field label="Roof Thickness (m)" htmlFor="roof-thick">
            <TextInput id="roof-thick" type="number" step="0.01" value={draft.design.roofThickness} onChange={(e) => setDraft((d) => ({ ...d, design: { ...d.design, roofThickness: Number(e.target.value) } }))} />
          </Field>
          <Field label="Floor Thickness (m)" htmlFor="floor-thick">
            <TextInput id="floor-thick" type="number" step="0.01" value={draft.design.floorThickness} onChange={(e) => setDraft((d) => ({ ...d, design: { ...d.design, floorThickness: Number(e.target.value) } }))} />
          </Field>
